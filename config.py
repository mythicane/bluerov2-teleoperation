...
# e.g. REPO_ROOT/"data"/"grab red rod"/{data,meta,videos}. Point this at
# wherever you want recordings to live -- defaults to the repo's data/
# folder, matching the empty "grab <color> rod[ under currents]" folders
